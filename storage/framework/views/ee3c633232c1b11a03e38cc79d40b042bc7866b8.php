    ...
    <div id="carouselExampleIndicators" class="carousel slide ml-auto mr-auto" data-ride="carousel">
        ...
        <div class="carousel-inner text-center">
            <div class="carousel-item active">
                <img class="d-block w-100" src="<?php echo e(asset('assets/img/slider/slider1.webp')); ?>" alt="First slide"
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="<?php echo e(asset('assets/img/slider/slider3.webp')); ?>" alt="Third slide"
                     style="height: 550px; object-fit: cover">
            </div>
        </div>
