                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" id="pemohon_id" name="pemohon_id">
                                            @foreach ($pemohon as $v)
                                                <option value="{{ $v->id }}"
                                                    {{ $permohonan->pemohon->id == $v->id ? 'selected' : '' }}>
                                                    {{ $v->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="namaDokumen" name="namaDokumen"
                                                value="{{ $permohonan->nama_dokumen }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" id="form"
                                                value="{{ $permohonan->tgl_permohonan }}" name="tgl_permohonan">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="luas_sementara" name="luas_sementara"
                                                value="{{ $permohonan->luas_sementara }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="hak_milik" name="hak_milik"
                                                value="{{ $permohonan->hak_milik }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <input type="file" class="custom-file-input" id="filePermohonan"
                                                    accept="application/pdf" name="filePermohonan" lang="en">
                                            </div>
                                        </div>
                                    </div>
                                </div>
